...
//HOMEWORK 3 TEST CASES for IF statements and SWITCH cases
TEST_CASE("Verify argument value using if statements", "output should return correct letter grade")
{
...
TEST_CASE("Verify argument value using switch case", "output should return correct letter grade")
{
